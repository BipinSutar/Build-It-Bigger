 ...
 * on 2016-11-01 at 10:32:26 UTC 
 * Modify at your own risk.
 */

package com.example.bipin.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://joker-148208.appspot.com/_ah/api/";
  ...
  public class GetJoke extends MyApiRequest<com.example.bipin.myapplication.backend.myApi.model.MyBean> {
     ...
     */
    protected GetJoke() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.bipin.myapplication.backend.myApi.model.MyBean.class);
    }
  ...
  public class SayHi extends MyApiRequest<com.example.bipin.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.bipin.myapplication.backend.myApi.model.MyBean.class);
